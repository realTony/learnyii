            ...
            <div class="card-block p-a-0">
                <div class="box-tab single-project-tab justified m-b-0">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#top" data-toggle="tab">Меню шапки</a>
                        </li>
                        <li>
                            <a href="#services" data-toggle="tab">Подвал первая секция</a>
                        </li>
                        <li>
                            <a href="#portfolio" data-toggle="tab">Подвал вторая секция</a>
                        </li>
                        <li>
                            <a href="#wanted" data-toggle="tab">Подвал третья секция</a>
                        </li>
                        <li>
                            <a href="#reviews" data-toggle="tab">Отзывы</a>
                        </li>
                        <li>
                            <a href="#seo-in-home" data-toggle="tab">Cоздание сайтов</a>
                        </li>
                        <li>
                            <a href="#footer" data-toggle="tab">Футер</a>
                        </li>
                    </ul>
