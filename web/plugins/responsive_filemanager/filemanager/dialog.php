...
<!-- header div end -->
	...
	<?php } ?>
	<li class="pull-right"><a id="refresh" class="btn-small" href="dialog.php?<?= $get_params.$subdir ?>"><i class=\"icon-refresh\"></i></a></li>
	...
	<div class="span12">
		...
		foreach ($files as $file_array) {
			...
			?>
				...
				<?php } ?>
				<a class="folder-link" href="dialog.php?<?= $get_params.rawurlencode($src) ?>">
					<div class=\"img-precontainer\">
							<div class=\"img-container directory\"><span></span>
							<img class=\"directory-img\" data-src="img/<?= $config['icon_theme']; ?>/folder<?php if($file==".."){ echo "_back"; }?>.png" />
							</div>
					</div>
			...
			<?php }else{ ?>
					...
					<div class="box">
					<h4 class="<?php if($config['ellipsis_title_after_first_row']){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="dialog.php?<?= $get_params.rawurlencode($src) ?>"><?= $file;?></a></h4>
					</div>
